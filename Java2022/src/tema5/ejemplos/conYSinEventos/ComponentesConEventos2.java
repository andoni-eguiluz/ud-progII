 ...
 */
public class ComponentesConEventos2 {

	/** Método principal de ejecución del ejercicio
	 * @param args	No utilizado
	 */
	public static void main(String[] args) {
		ComponentesConEventos2 mgt = new ComponentesConEventos2();
		mgt.run();
	}
	...
	private void dragEnEspacio( Point pInicial, Point pActual ) {
		...
		((Graphics2D)panel.getGraphics()).setColor(Color.MAGENTA);
		panel.getGraphics().drawRect( x, y, anc, alt );
		panel.repaint();
	}
