package tema5.ejemplos.panelesHerencia;

public class Trabajador {
	private String nombre;
	private double eficiencia;       // Eficiencia 1.0 es que tarda el tiempo estándar. 2.0 Tarda la mitad y así sucesivamente
	private double tiempoPendiente;  // Tiempo que está ocupado el trabajador/a (0 = libre) en segundos
	 ...
	 */
	public void pasaElTiempo( double segundos ) {
		if (tiempoPendiente==0) return; // Si el trabajador está libre sigue libre (nada que hacer)
		double segundosMenos = segundos * eficiencia;  // El tiempo pasa en función de la eficiencia
	...
	/** Devuelve la información de trabajador incluido su estado y tiempo de ocupación
	 * @return	Nombre del trabajador seguido de info de libre o trabajando-tiempo
	 */
	public String getInfoTrabajador() {
		if (isLibre()) {
			return getNombre() + ":libre"; 
		} else {
			return getNombre() + ":trabajando-" + getTiempoPendiente() + "sgs."; 
		}
	}
