...
public class Consulta extends Registro implements RegistroDeUsuario {
	 ...
	 */
	public static Consulta crearDeLinea( String linea ) throws ParseException {
	...
	public String sacaLinea() {
		// Quiero conseguir "Consulta	18/03/2022 12:00	andoni	Consulta de operaciones	9	92500"
		return "Consulta\t" + FORMATEADOR_FECHA.format( fecha ) + "\t" + usuario + "\t" + tipoConsulta + "\t" + gradoSatisfaccion + "\t" + tiempoAtencionMilis;
	}
}
