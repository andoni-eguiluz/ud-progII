...
public class PrecioElectricidad extends Registro implements ConPrecio {
	 ...
	 */
	public static PrecioElectricidad crearDeLinea( String linea ) throws ParseException {
...
//		}
	...
	public String sacaLinea() {
		// Modelo a sacar: PrecioElectricidad	15/03/2022 20:00	0.480
		return "PrecioElectricidad\t" + FORMATEADOR_FECHA.format( fecha ) + "\t" + precioKwH;
	}
