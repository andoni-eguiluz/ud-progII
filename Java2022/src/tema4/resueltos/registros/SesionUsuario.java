...
public class SesionUsuario extends Registro implements RegistroDeUsuario {
	 ...
	 */
	public static SesionUsuario crearDeLinea( String linea ) throws ParseException {
	...
	public String sacaLinea() {
		// Modelo a sacar: DuracionSesion	14/03/2022 10:32	elena	93500
		return "DuracionSesion\t" + FORMATEADOR_FECHA.format( fecha ) + "\t" + usuario + "\t" + duracionSesionMilis;
	}
