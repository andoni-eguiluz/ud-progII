...
public class PrecioCarburante extends Registro implements ConPrecio {
	 ...
	 */
	public static PrecioCarburante crearDeLinea( String linea ) throws ParseException {
	...
	public boolean equals(Object obj) {
		if (obj instanceof PrecioCarburante) {
			PrecioCarburante pc2 = (PrecioCarburante) obj;
			return fecha.equals(pc2.fecha) && precioPorLitro==pc2.precioPorLitro;
		} else {
			return false;
		}
	}
	...
	@Override
	public int hashCode() {
		return fecha.hashCode() + (int) precioPorLitro;
	}

	@Override
	public String sacaLinea() {
		// Modelo a sacar: PrecioCarburante	18/03/2022 12:00	Repsol	GASOLEO_A	1.733
		return "PrecioCarburante\t" + FORMATEADOR_FECHA.format( fecha ) + "\t" + companyia + "\t" + tipo + "\t" + precioPorLitro;
	}
}
